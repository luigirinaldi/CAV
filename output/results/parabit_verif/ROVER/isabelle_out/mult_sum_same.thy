...
if "(t > p)" and "(t > 1)" and "(s >= (p + q))" and "(1 > 0)" and "(q > 0)" and "(p > 0)" and "(s > 0)" and "(t > 0)" and "(r > 0)"
for t q r p s :: nat and a b :: int
proof -
    ...
    moreover have "... = (bw r ((bw q b) * ((bw p a) + (bw 1 1))))" using that by (simp add: bw_def)
