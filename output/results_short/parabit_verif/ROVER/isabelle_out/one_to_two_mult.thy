...
if "(q > (p + 2))" and "(q > p)" and "(p > 0)" and "(1 > 0)" and "(2 > 0)" and "(q > 0)"
...
note inferred_facts =fact_0 fact_1 fact_2 fact_3 fact_4 
    have "?lhs = (bw p (1 * (bw p x)))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw p ((bw p x) * (2 + (-1))))" using that by (simp add: bw_def)
    moreover have "... = (bw p ((bw p x) * (2 + (not 0))))" using that by (simp add: bw_def)
    moreover have "... = (bw p ((bw p x) * (2 + (not (bw 1 (-2))))))" using that by (simp add: bw_def)
    moreover have "... = (bw p ((bw p x) * (2 + (not (bw 1 (not 1))))))" using that by (simp add: bw_def)
    moreover have "... = (bw p ((bw p x) * (2 + (not (bw 1 (not (bw 1 1)))))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw p ((bw q ((bw 2 2) * (bw p x))) + ((bw p x) * (not (bw 1 (not (bw 1 1)))))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw p ((bw q ((bw 2 2) * (bw p x))) + ((not (bw 1 (not 1))) * (bw p x))))" using that by (simp add: bw_def)
    moreover have "... = (bw p ((bw q ((bw 2 2) * (bw p x))) + ((not (bw 1 (-2))) * (bw p x))))" using that by (simp add: bw_def)
    moreover have "... = (bw p ((bw q ((bw 2 2) * (bw p x))) + ((not 0) * (bw p x))))" using that by (simp add: bw_def)
    moreover have "... = (bw p ((bw q ((bw 2 2) * (bw p x))) + ((-1) * (bw p x))))" using that by (simp add: bw_def)
