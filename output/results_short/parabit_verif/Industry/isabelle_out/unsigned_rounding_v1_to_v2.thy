...
if "(w2 > 1)" and "(((w2 + 1) - w2) >= 1)" and "(1 > 0)" and "(w2 > 0)" and "((w2 + 1) > 0)"
...
note inferred_facts =fact_0 fact_1 
    ...
    moreover have "... = (bw w2 ((and (bw 1 (-1)) (bw w2 (bw (w2 + 1) a))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((and (or (and (and (bw (w2 + 1) a) (bw 1 1)) 1) (bw 1 (-1))) (bw w2 (bw (w2 + 1) a))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((and (or (and 1 (and (bw (w2 + 1) a) (bw 1 1))) 1) (bw w2 (bw (w2 + 1) a))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw w2 (or (bw 1 a) (and (bw 1 a) (and (bw (w2 + 1) a) 1)))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw w2 (or (bw 1 a) (and (and (bw (w2 + 1) a) (bw 1 1)) (bw 1 a)))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw w2 (or (bw 1 a) (and (and (bw (w2 + 1) a) (bw 1 1)) (and (bw (w2 + 1) a) (bw 1 1))))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw w2 (or (bw 1 a) (and (bw (w2 + 1) a) 1))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw w2 (or (and (bw (w2 + 1) a) (bw 1 1)) (bw 1 a))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw w2 (or (and (bw (w2 + 1) a) (bw 1 1)) (and (bw (w2 + 1) a) (bw 1 1)))) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw w2 (and (bw (w2 + 1) a) 1)) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((and (bw (w2 + 1) a) (bw 1 1)) + ((bw (w2 + 1) a) >> (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((((bw 1 (not (bw 1 a))) + (((bw (w2 + 1) a) div (2 ^ nat (1))) * 2)) div 2) + (and (bw (w2 + 1) a) (bw 1 1))))" using that by (simp add: bw_def)
    moreover have "... = (bw w2 ((((bw 1 (not (bw 1 a))) + (((bw (w2 + 1) a) div 2) * 2)) div 2) + (and (bw (w2 + 1) a) (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 (((xor (bw (w2 + 1) a) (bw 1 1)) div 2) + (and (bw (w2 + 1) a) (bw 1 1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 (((bw (w2 + 1) a) + (bw 1 1)) div (2 ^ nat (1))))" using that by (simp add: bw_def)
    ...
    moreover have "... = (bw w2 ((bw (w2 + 1) ((bw (w2 + 1) a) + (bw 1 1))) >> (bw 1 1)))" using that by (simp add: bw_def)
