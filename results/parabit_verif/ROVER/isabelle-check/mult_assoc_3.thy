...
if "((r + s) <= q)" and "(u >= t)" and "(u > 0)" and "(q > 0)" and "(r > 0)" and "(s > 0)" and "(p > 0)" and "(t > 0)"
for u p r s q t :: nat and c b a :: int
proof -
    ...
    moreover have "... = (bw t ((bw p a) * (bw q ((bw r b) * (bw s c)))))" using mul_full_prec that by (simp ; fail | simp only: mul_full_prec; fail | simp add: mul_full_prec; fail | blast; fail | metis)
