...
proof -
    ...
    moreover have "... = (bw k (and (bw k (not (bw k (not (bw k (not (bw k (not (bw k var_nx))))))))) (bw k (not (bw k var_y)))))" using not_bw_not that by (simp only: not_bw_not; fail | simp add: not_bw_not; fail | blast; fail | metis)
    moreover have "... = (bw k (and (bw k (not (bw k (not (bw k var_nx))))) (bw k (not (bw k var_y)))))" using not_bw_not that by (simp only: not_bw_not; fail | simp add: not_bw_not; fail | blast; fail | metis)
