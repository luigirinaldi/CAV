...
proof -
    have "?lhs = (bw k ((bw k C) - (xor (bw k var_x) (bw k (not (bw k 0))))))" using diff_right_eq_prec that by (simp only: diff_right_eq_prec; fail | simp add: diff_right_eq_prec; fail | blast; fail | metis)
    moreover have "... = (bw k ((bw k C) - (bw k (xor (bw k var_x) (bw k (not (bw k 0)))))))" using xor_remove that by (simp only: xor_remove; fail | simp add: xor_remove; fail | blast; fail | metis)
    moreover have "... = (bw k ((bw k C) + ((-1) * (bw k (xor (bw k var_x) (bw k (not (bw k 0))))))))" using sub_to_neg that by (simp only: sub_to_neg; fail | simp add: sub_to_neg; fail | blast; fail | metis)
    ...
    moreover have "... = (bw k (C - (bw k (xor (bw k var_x) (bw k (not (bw k 0)))))))" using sub_to_neg that by (simp only: sub_to_neg; fail | simp add: sub_to_neg; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (bw k ((or (bw k var_x) (bw k (not (bw k 0)))) - (and (bw k var_x) (bw k (not (bw k 0))))))))" using xor_as_or_and that by (simp only: xor_as_or_and; fail | simp add: xor_as_or_and; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (bw k ((bw k (or (bw k var_x) (bw k (not (bw k 0))))) - (and (bw k var_x) (bw k (not (bw k 0))))))))" using that mod_prop_sub_left by (blast; fail | metis)
    moreover have "... = (bw k (C - ((bw k (or (bw k var_x) (bw k (not (bw k 0))))) - (and (bw k var_x) (bw k (not (bw k 0)))))))" using diff_right_eq_prec that by (simp only: diff_right_eq_prec; fail | simp add: diff_right_eq_prec; fail | blast; fail | metis)
    moreover have "... = (bw k (C - ((or (bw k var_x) (bw k (not (bw k 0)))) - (and (bw k var_x) (bw k (not (bw k 0)))))))" using or_remove that by (simp only: or_remove; fail | simp add: or_remove; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (xor (bw k var_x) (bw k (not (bw k 0))))))" using xor_as_or_and that by (simp only: xor_as_or_and; fail | simp add: xor_as_or_and; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (and (or (bw k var_x) (bw k (not (bw k 0)))) (or (bw k (not (bw k var_x))) (bw k (not (bw k (not (bw k 0)))))))))" using xor_and_or that by (simp only: xor_and_or; fail | simp add: xor_and_or; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (and (bw k (or (bw k var_x) (bw k (not (bw k 0))))) (or (bw k (not (bw k var_x))) (bw k (not (bw k (not (bw k 0)))))))))" using or_remove that by (simp only: or_remove; fail | simp add: or_remove; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (and (or (bw k var_x) (bw k (not (bw k 0)))) (or (bw k (not (bw k var_x))) (bw k (not (bw k (not (bw k 0)))))))))" using or_remove that by (simp only: or_remove; fail | simp add: or_remove; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (xor (bw k var_x) (bw k (not (bw k 0))))))" using xor_and_or that by (simp only: xor_and_or; fail | simp add: xor_and_or; fail | blast; fail | metis)
    moreover have "... = (bw k (C - (bw k (xor (bw k var_x) (bw k (not (bw k 0)))))))" using xor_remove that by (simp only: xor_remove; fail | simp add: xor_remove; fail | blast; fail | metis)
    moreover have "... = (bw k (C + ((-1) * (bw k (xor (bw k var_x) (bw k (not (bw k 0))))))))" using sub_to_neg that by (simp only: sub_to_neg; fail | simp add: sub_to_neg; fail | blast; fail | metis)
