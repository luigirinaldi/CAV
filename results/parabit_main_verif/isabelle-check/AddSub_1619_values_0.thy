...
proof -
    ...
    moreover have "... = (bw k (((bw k var_X) - (bw k var_Y)) - (bw k (bw k var_X))))" using that mod_prop_sub_right by (blast; fail | metis)
    moreover have "... = (bw k (((bw k var_X) - (bw k var_Y)) - (bw k var_X)))" using mod_eq that by (simp only: mod_eq; fail | simp add: mod_eq; fail | blast; fail | metis)
    ...
    moreover have "... = (bw k ((bw k (bw k 0)) + ((-1) * (bw k var_Y))))" using bw_0 that by (simp only: bw_0; fail | simp add: bw_0; fail | blast; fail | metis)
    moreover have "... = (bw k ((bw k 0) + ((-1) * (bw k var_Y))))" using bw_0 that by (simp only: bw_0; fail | simp add: bw_0; fail | blast; fail | metis)
    ...
    moreover have "... = (bw k ((bw k (bw k 0)) - (bw k var_Y)))" using bw_0 that by (simp only: bw_0; fail | simp add: bw_0; fail | blast; fail | metis)
    moreover have "... = (bw k ((bw k 0) - (bw k var_Y)))" using diff_left_eq_prec that by (simp only: diff_left_eq_prec; fail | simp add: diff_left_eq_prec; fail | blast; fail | metis)
