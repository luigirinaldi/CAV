...
uv run parabit_runner.py ../benchmarks/Alive/bwlang ../smoke_test/parabit_verif/Alive -j 8 -m 1 -t 1 --check-isabelle --quiet
uv run parabit_runner.py ../benchmarks/Hydra/bwlang ../smoke_test/parabit_verif/Hydra -j 8 -m 1 -t 1 --check-isabelle --quiet
